...
- [Write Assist AI - Visual Studio Marketplace](https://marketplace.visualstudio.com/items?itemName=ra-jeev.write-assist-ai)
...
- [General Extensions Pack - Visual Studio Marketplace](https://marketplace.visualstudio.com/items?itemName=MatthiasBohn.general-extensions-pack)
- [Docslate - Visual Studio Marketplace](https://marketplace.visualstudio.com/items?itemName=xavidev.docslate)
- [提高文档翻译效率神器：VS Code 插件之 Translator Helper-CSDN博客](https://blog.csdn.net/sD7O95O/article/details/103951867)
- [md-translator - Visual Studio Marketplace](https://marketplace.visualstudio.com/items?itemName=knighthood2001.md-translator)
- [remark translate "vscode" - Google Search](https://www.google.com/search?q=remark+translate+%22vscode%22&num=50)
- [remarkjs/remark-rehype: plugin that turns markdown into HTML to support rehype](https://github.com/remarkjs/remark-rehype)
